...
- [ ] O tema específico está delimitado (área, tempo, espaço ou aplicação)
- [ ] A problemática está formulada como pergunta
- [ ] O objetivo geral está no infinitivo, claro e mensurável
- [ ] Foram listados de 4 a 5 assuntos do artigo
- [ ] A estrutura do artigo foi definida (introdução, desenvolvimento, considerações finais)
- [ ] Os objetivos específicos foram classificados em Conceituais e Técnicos
